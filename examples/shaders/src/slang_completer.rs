	...
	fn slang () -> Self
	{
		Syntax {
			...
			keywords: BTreeSet::from([
				...
				"var", "for", "do", "while", "switch", "import", "mod", "type", "associatedtype", "typealias", "return",
				"where", "override", "in", "out", "inout", "this", "public", "property", "get", "set"
			]),
			types: BTreeSet::from([
				// Primitives
				...
				// Complex primitive
				"float2", "float3", "float4", "float2x2", "float3x2", "float4x2", "float2x3", "float3x3", "float4x3",
				"float2x4", "float3x4", "float4x4", "half2", "half3", "half4", "half2x2", "half3x2", "half4x2",
				...
				"asin", "acos", "atan", "atan2", "sinh", "cosh", "tanh", "min", "max", "clamp", "saturate", "lerp",
				"length", "normalize", "step", "smoothstep", "ddx", "ddy", "fwidth"
			]),
